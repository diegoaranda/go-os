...
function TabsContent({ className, ...props }: TabsPrimitive.Panel.Props) {
  return (
    <TabsPrimitive.Panel
      ...
      className={cn("motion-enter flex-1 text-sm outline-none", className)}
      {...props}
    />
  )
}
